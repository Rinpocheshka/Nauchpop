...
- В КАЖДОМ ОПИСАНИИ ОБЯЗАТЕЛЬНО встрой ссылку ВНУТЬ текста, не отдельной строкой. Каждый раз ИСПОЛЬЗУЙ РАЗНУЮ формулировку для ссылки, чередуй из этих вариантов (или придумай свою):
  ...
  ВАЖНО: КАЖДАЯ ссылка в посте должна иметь РАЗНУЮ формулировку. НИКОГДА не используй одну и ту же фразу дважды в одном посте. Также избегай фраз, которые использовались в последних постах.
