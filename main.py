...
- Каждый раз придумывай новые короткие реплики, НИКОГДА не повторяй одни и те же фразы в разных постах
...
- В КАЖДОМ ОПИСАНИИ ОБЯЗАТЕЛЬНО встрой ссылку ВНУТЬ текста, не отдельной строкой. Каждый раз ИСПОЛЬЗУЙ РАЗНУЮ формулировку для ссылки, чередуй из этих вариантов (или придумай свою):
  ...
  • <a href="URL">Кто хочет разобраться — жми сюда</a>
  • <a href="URL">Для тех, кому мало — вот исходник</a>
  • <a href="URL">Статья целиком тут</a>
  • <a href="URL">Источник — тапай сюда</a>
  • <a href="URL">Полный текст по ссылке</a>
  • <a href="URL">Ещё подробности тут</a>
  ВАЖНО: КАЖДАЯ ссылка в посте должна иметь РАЗНУЮ формулировку. НИКОГДА не используй одну и ту же фразу дважды в одном посте. Если в прошлом посте ты использовал «Если хочешь копнуть глубже» — сегодня НЕ используй её вообще.
