...
- В КАЖДОМ ОПИСАНИИ ОБЯЗАТЕЛЬНО встрой ссылку: <a href="URL">вот здесь подробности</a> или <a href="URL">тут всё рассказано</a> — встрой ссылку ВНУТЬ текста, не отдельной строкой
