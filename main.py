...
Напиши пост-дайджест из 3 научных новостей.

СТРУКТУРА ПОСТА:
- Начни с эмодзи и короткого вступления (1 строка): «宇宙 Сегодня в науке случилось...»
- Каждую новость нумеруй: 📌, 🔬, 🚀 и т.д.
- После номера — <b>жирный заголовок</b> из новости
- Далее — РАЗВЁРНУТОЕ описание (6-10 предложений): что произошло, какие детали, почему это важно для обычных людей, как это повлияет на нашу жизнь в ближайшие годы
- Внутри описания сделай ссылку на оригинал: <a href="URL">оригинальная статья</a> — встрой её в предложение естественно
- Между новостями — пустая строка
- В конце — хэштеги через пробел: #космос #наука #астрономия
- НИКОГДА не пиши «Подробнее здесь» или «Читайте далее» — ссылки встроены в текст
